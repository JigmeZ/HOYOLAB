  ...
  return (
    <div className="login-modal-overlay">
      <div className="login-modal">
        ...
        <form className="login-form">
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            ...
            <button
              ...
              style={{ width: 80, padding: 0, margin: 0, borderRadius: 8, fontSize: 14 }}
              disabled={!email}
            >
              Send
            </button>
          ...
          />
          <label style={{ fontSize: 13, color: '#aaa', marginTop: 8, display: 'flex', alignItems: 'flex-start', gap: 8 }}>
            <input
              type="checkbox"
              checked={agreed}
            ...
            <span>
              ...
              <a href="#" style={{ color: '#4e88ff' }}>Terms of Service</a>,{' '}
              <a href="#" style={{ color: '#4e88ff' }}>Privacy Policy</a>,{' '}
              <a href="#" style={{ color: '#4e88ff' }}>HoYoLAB Terms of Service</a> and{' '}
              <a href="#" style={{ color: '#4e88ff' }}>HoYoLAB Privacy Policy</a>
            </span>
          </label>
          <button
            type="submit"
        ...
        <div style={{ marginTop: 18, textAlign: 'center', color: '#aaa', fontSize: 15 }}>
